...
def get_local_file_as_data_uri(file_name):
    ...
    # Garante que procura na pasta onde o script está
...
with st.sidebar:
    ...
    # Mapeamento de nomes de arquivos esperados
    file_map = {
        "Música": "musica.mp3",
        "Idle": "sprite_p.png",
        "Esquerda": "sprite_e.png",
        "Baixo": "sprite_b.png",
        "Cima": "sprite_c.png",
        "Direita": "sprite_d.png"
    }
    ...
    # Resumo visual dos sprites
    st.caption(f"P: {idle_status} | E: {left_status} | B: {down_status} | C: {up_status} | D: {right_status}")
...
# Se faltar a música, avisa o usuário
if not audio_uri:
    st.warning("⚠️ Arquivo 'musica.mp3' não encontrado na pasta e nenhum upload foi feito. O jogo ficará sem som.")
